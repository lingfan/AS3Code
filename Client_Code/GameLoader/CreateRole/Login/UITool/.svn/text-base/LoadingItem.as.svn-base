package CreateRole.Login.UITool
{
    ...
    public class LoadingItem extends EventDispatcher 
    {
		...
		public function load() : void
        {
            ...
            if (preventCache)
            {
                var cacheString : String = "Cache=" + getTimer();

                if(url.indexOf("?") == -1)
                {
                    urlNew = this.url + "?" + cacheString;
                }
                else
                {
                    urlNew = this.url + "&" + cacheString;
        ...
        public function onStartedHandler(e : Event) : void
        {
            ...
            latency      = LoadingItem.TruncateNumber((responseTime - startTime)/1000);
        ...
        private function CalculateSpeed():void
        {
            ...
            speed = LoadingItem.TruncateNumber((bytesLoaded / 1024) / (timeToDownload));
        }
