package
{
	...
	public class GameConfigData
	{
		...
		/** 宝石熔炼合成配方数据swf */
		public static const FireInStone:String              = "Resources/GameData/peifang.swf";
		...
		/**任务xml */
		public static const GameTaskInfoList:Array	   = ["Resources/taskInfo.swf","Resources/GameData/task.xml"];
		/** 江湖指南SWF  */
		...
		/** 技能学习页面 */
		public static var SkillLeran:String 			= "Resources/GameDLC/SkillLearn.swf";
		
		/** 宠物页面 */
		public static var PetUI:String 			= "Resources/GameDLC/PetUILibrary.swf";
		
		/** 背包页面 */
		public static var BagUI:String 			= "Resources/GameDLC/BagUILibrary.swf";
		
		/** 锻造页面 */
		public static var ForgeUI:String 			= "Resources/GameDLC/ForgeUILibrary.swf";
		
		/** 宝石资源路径 */
		public static var StoneUI:String 			= "Resources/GameDLC/StoneUILibrary.swf";
		
		/** 熔炼资源路径 */
		public static var MeltUI:String 			= "Resources/GameDLC/MeltUILibrary.swf";
		
		/** 人物属性页面 */
		public static var RolePropUI:String 			= "Resources/GameDLC/RolePropUILibrary.swf";
		
		/** 坐骑页面 */
		public static var MountUI:String 			= "Resources/GameDLC/MountUILibrary.swf";
		
		/**帮派面板**/
		public static var UnityUI:String	=	"Resources/GameDLC/UnityUILibrary.swf";
		
		/** 商城页面 */
		public static var MarketUI:String = "Resources/GameDLC/MarketPanel.swf";
		
		/** 经脉页面 */
		public static var MeridianUI:String = "Resources/GameDLC/Meridianpanel.swf";
		
		/** NPC商店页面 */
		public static var NpcShopUI:String = "Resources/GameDLC/NPCShop.swf";
		...
		/**锻造*/
		public static var Forge_XML_SWF:String = "Resources/GameData/ForgeXML.swf";
		...
		/**经脉配置**/
		public static var Meridians_XML_SWF:String = "Resources/GameData/MeridiansXML.swf";
		
		/** 简体繁体文字配置swf */
		public static const Word_Config_SWF:String		   = "Resources/WordConfig.swf"; 
		
		/** 功能开启提示页面 */
		public static const Open_Menu_SWF:String 		="Resources/GameDLC/MenuOpen.swf";	 
